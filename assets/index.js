...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function jsonAll(fichier) {
    function sendInscription() {
      ...
      var data =
        "&titre=" + titre + "&auteur=" + auteur + "&reference=" + reference;
      ...
      if (xhr != false) {
        ...
        xhr.onreadystatechange = function () {
          ...
          document.getElementById("form_ajoute_livre").innerHTML =
            affiche_retour;
        };
  ...
  jsonAll(  "../forum/readall_topic.php");
  jsonAll(  "../message/readall_msg.php");
  jsonAll(  "../utilisateur/readall_users.php");
});
